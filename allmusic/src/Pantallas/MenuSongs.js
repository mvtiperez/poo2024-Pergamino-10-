      ...
      <div className="container">
        ...
        <div className="main-container">
          ...
          <div className="button-container">
            <button onClick={() => handleNavigation("/todasCanción")}>
              Todas las Canciones
            </button>

            {userType === "artist" && (
              <>
                <button onClick={() => handleNavigation("/crearCanción")}>
                  Crear Canción
                </button>
                <button onClick={() => handleNavigation("/actualizarCanción")}>
                  Actualizar Canción
                </button>
                <button onClick={() => handleNavigation("/eliminarCanción")}>
                  Eliminar Canción
                </button>
              </>
            )}

            <button onClick={() => handleNavigation("/buscarCanción")}>
              Buscar Canción
            </button>

            {userType === "artist" && (
              <button onClick={() => handleNavigation("/misCanción")}>
                Mis Canciones
              </button>
            )}

            {userType === "enthusiast" && (
              <button onClick={() => handleNavigation("/agregarAPlaylist")}>
                Agregar a Playlist
              </button>
            )}
          </div>
